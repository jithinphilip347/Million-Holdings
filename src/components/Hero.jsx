...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 container mx-auto px-6 flex flex-col items-center md:items-start text-center md:text-left pt-24 md:pt-40">
        <div ref={textRef} className="max-w-4xl text-white">
          <span className="inline-block py-1 px-3 border border-white text-white text-xs md:text-sm font-semibold mb-4 md:mb-6 tracking-wide uppercase">
            Recruitment Experts
          </span>
          ...
          <p className="text-base md:text-xl text-gray-300 mb-8 md:mb-10 max-w-xl md:max-w-2xl mx-auto md:mx-0 leading-relaxed">
